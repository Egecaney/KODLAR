...
int main(void){
    ...
    // Subscribe("IOT");
    while (1){
        Publish("g25datas","23,17,11.");
        __delay_cycles(2400000);
        Publish("g25datas","23,17,11.");
        __delay_cycles(2400000);
        Publish("g25datas","23,17,11.");
        __delay_cycles(2400000);
        Publish("g25datas","23,17,15.");
        __delay_cycles(2400000);
        Publish("g25datas","23,17,19.");
        __delay_cycles(2400000);
        Publish("g25datas","23,17,24.");
        __delay_cycles(2400000);
        Publish("g25datas","23,17,26.");
        __delay_cycles(2400000);
        Publish("g25datas","23,17,29.");
        __delay_cycles(2400000);
        Publish("g25datas","23,17,34.");
        __delay_cycles(2400000);
        Publish("g25datas","23,17,39.");
        __delay_cycles(2400000);
        Publish("g25datas","23,17,43.");
        __delay_cycles(2400000);
        Publish("g25datas","23,17,49.");
        __delay_cycles(2400000);
        Publish("g25datas","23,17,56.");
        __delay_cycles(2400000);
        Publish("g25datas","23,17,68.");
        __delay_cycles(2400000);
        Publish("g25datas","23,17,70.");
        __delay_cycles(2400000);
        Publish("g25datas","23,17,77.");
        __delay_cycles(2400000);
    }
}
